...
$(MAKE) -j$(CPUS) tcp-server.cooja TARGET=cooja</commands>
      ...
      <mote>
        <interface_config>
          ...
          <pos x="94.97439728243907" y="20.94525235287697" />
        </interface_config>
        <interface_config>
...
$(MAKE) -j$(CPUS) tcp-client.cooja TARGET=cooja</commands>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="99.9753392428632" y="20.976394008966842" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.contikimote.interfaces.ContikiMoteID
          <id>2</id>
  ...
  <plugin>
    ...
    <bounds x="398" y="0" height="406" width="879" z="1" />
  </plugin>
  <plugin>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>70.04135021855352 0.0 0.0 70.04135021855352 -6630.771385491716 -1335.6243572841263</viewport>
    </plugin_config>
